...
const[data, setData] = useState([])
  ...
  useEffect(() => {
    ...
    getAdminData("mof")
    .then( res => setData(res[0].contact) )
        ...
        <Container>
            ...
            <div className="socials__time flex">
                ...
                <div className="account flex gap__30">
                    <a target = '_blank' href= {data?.socials?.instagram} className="icon"><Instagram width={22} strokeWidth={1.6}/></a> 
                    <a target = '_blank' href = {data?.socials?.x} className="icon"><X width={22} strokeWidth={1.6}/></a>
                    <a target = '_blank' href=  {data?.socials?.facebook} className="icon"><FacebookTag width={22} strokeWidth={1.6}/></a>
                </div>
            </div>
