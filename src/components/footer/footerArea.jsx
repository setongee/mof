              ...
              <div className="linksPart flex">
                  ...
                  <div className="linkHolder flex flex__column fritz">
                      ...
                      <div className='flex flex__column gap__30 badger'>
                        ...
                        <a href = 'mailto:finance@lagosstate.gov.ng' target='_Blank' className='flex font__14 gap__15 dark'> 
                  ...
                  <div className="linkHolder flex flex__column">
                      ...
                      <div className="linkHeader thick_500">About MOF</div>

                      <div className="links a-dark flex flex__column">

                          <a href="/about/vision" className="link"> <span><ArrowUpRight/></span> Our Vision & Mission </a>

                          <a href="/about/responsibilities" className="link"> <span><ArrowUpRight/></span> Responsibilities </a>

                          <a href="/about/people" className="link"> <span><ArrowUpRight/></span> Top Management  </a>

                          <a href="/about/agencies_directorates_units" className="link"> <span><ArrowUpRight/></span> Agencies </a>
                  ...
                  <div className="linkHolder flex flex__column">
                      ...
                      <div className="linkHeader thick_500">Other Supervised MDAs</div>

                      <div className="links a-dark flex flex__column">

                          <a target = '_blank' href="/services/jobs" className="link"> <span><ArrowUpRight/></span> Land Use Charge </a>

                          <a target = '_blank' href="/services/housing" className="link"> <span><ArrowUpRight/></span> Lagos State Lottery Board </a>
